...
def get_all_products(connection):
    ...
    query = ("SELECT products.product_id, products.name, products.uom_id,products.price,"
...
def insert_new_product( connection , product):
    cursor = connection.cursor()
    query = "Insert into products(name, uom_id, price) VALUES(%s, %s, %s)"
